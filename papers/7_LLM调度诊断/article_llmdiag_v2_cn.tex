...
CRN 判分的确定性假设成立。LLM 臂（32B 与 30B-A3B-Thinking, n=133 重仿真）干预成功率 0.31--0.32（规则臂 0.667）; greedy/涌现臂近乎全灭（0--7%）——药房缺治疗涌现失效的旋钮; 且 padding 在脆弱配置上出现 ΔKPI $-3585$ 的灾难性伤害——干预评估层捕获了纯文本评分不可能发现的``治疗副作用''。
